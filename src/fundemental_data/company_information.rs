...
pub struct CompanyInformation {
    ...
    #[serde(rename = "MarketCapitalization", deserialize_with="de_from_str_to_int")]
    ...
    pub eps: f32,
    #[serde(rename = "RevenuePerShareTTM", deserialize_with = "de_from_str_to_float")]
    pub revenue_per_share_ttm: f32,
    #[serde(rename = "ProfitMargin", deserialize_with = "de_from_str_to_float")]
    pub profit_margin: f32,
    #[serde(rename = "OperatingMarginTTM",deserialize_with = "de_from_str_to_float")]
    pub operating_margin_ttm: f32,
    #[serde(rename = "ReturnOnAssetsTTM",deserialize_with = "de_from_str_to_float")]
    pub return_on_assets_ttm: f32,
    #[serde(rename = "ReturnOnEquityTTM",deserialize_with = "de_from_str_to_float")]
    ...
    #[serde(rename = "QuarterlyEarningsGrowthYOY",deserialize_with = "de_from_str_to_float")]
    pub quarterly_earnings_growth_yoy: f32,
    #[serde(rename = "QuarterlyRevenueGrowthYOY",deserialize_with = "de_from_str_to_float")]
    pub quarterly_revenue_growth_yoy: f32,
    #[serde(rename = "AnalystTargetPrice",deserialize_with = "de_from_str_to_float")]
    ...
    pub forward_pe: f32,
    #[serde(rename = "PriceToSalesRatioTTM",deserialize_with = "de_from_str_to_float")]
    ...
    pub n52week_low: f32,
    #[serde(rename = "50DayMovingAverage",deserialize_with = "de_from_str_to_float")]
    pub n50day_moving_average: f32,
    #[serde(rename = "200DayMovingAverage",deserialize_with = "de_from_str_to_float")]
...
fn get_external_data(company: &str) -> Result<CompanyInformation, Box<dyn std::error::Error>> {
    let url = format!(
        "https://www.alphavantage.co/query?function=OVERVIEW&symbol={}&apikey=demo",
        company
    );
